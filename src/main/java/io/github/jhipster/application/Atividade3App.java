...
public class Atividade3App {

    private static final Logger log = LoggerFactory.getLogger(Atividade3App.class);

    private final Environment env;

    public Atividade3App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes Atividade3.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Atividade3App.class);
